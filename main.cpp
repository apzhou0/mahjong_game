...
int main(int argc, char** argv){
    std::cout << "2-Player Mahjong Simulation by Audrey Zhou" << std::endl
    ...
    while (!validInput) {
        if (preStart == "b" || preStart == "B") {
            ...
            std::cout << "'PONG' AND 'CHOW':" << std::endl
                      ...
                      << "This new triple will be taken out from your hand and cannot be taken back. You must then discard a tile." << std::endl
                      ...
                      << "This new triple will also be taken out from your hand and cannot be taken back. You must then discard a tile." << std::endl << std::endl;
            ...
            std::cout << "Input not recognized. Enter 'g' to view a guide to the game or 'b' to begin playing." << std::endl;
            std::cin >> preStart;
        }
    }
}